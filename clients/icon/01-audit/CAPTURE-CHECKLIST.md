...
Generated 2026-07-31 by `run_audit.py`. Nothing below is optional; the audit
...
9 prompts × 1 engine(s) were generated from the category,
...
## 5. Re-run
    ...
    python _system/run_audit.py https://icon.com --reviewed
